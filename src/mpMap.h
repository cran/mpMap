...
void pedfunnel(int i, int *id, int *mother, int *father, int *ofunnel, int nfounders, int nped);
...
void hap3ptfull(int *finalg, int *founderg, int *id, int *mother, int *father, int *nfinals, int *nfounders, int *nmrk, int *nped, double *out, double *r12, double *r23, double *r13, int *left, int *mid, int *right, int *npos);
